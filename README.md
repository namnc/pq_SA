...
pq_SA/
├── contracts/
│   ├── src/MemoRegistry.sol       Stealth address discovery log (15 Foundry tests)
...
│   │   └── tests/e2e.rs           9 integration tests (incl. delegation safety + adversarial)
...
# Test (30 Rust + 15 Foundry = 45 total)
cargo test --release
